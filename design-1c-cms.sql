...
--
-- Host: 127.0.0.1    Database: design-1c-class_management
-- ------------------------------------------------------
...
CREATE TABLE `attendance_table` (
  ...
  `class_id` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `classes` (
  ...
  PRIMARY KEY (`id`),
  KEY `class_teacher_foreign_key_idx` (`teacher_id`)
...
CREATE TABLE `students` (
  `id` int NOT NULL AUTO_INCREMENT,
  `student_number` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `course` varchar(16) COLLATE utf8mb4_general_ci NOT NULL,
  `first_name` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `last_name` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'admin','$2y$10$KhCIkiSQCgR32lRg66xF/eUIjC19VaKo8NFMnX63w06nFXl7U.h/O','admin','2024-02-08 09:53:37');
...
-- Dump completed on 2024-04-10 15:16:18
